...
<div class="row clearfix">
    ...
    <div class="col-md-9">
        @if (!empty($users->profilePicture))
            <img src="{{asset('images/profile')}}/{{$users->profilePicture}}" class="alignleft img-circle img-thumbnail my-0" alt="Avatar" style="max-width: 84px;">
        @else
    ...
    <div class="col-md-3">
        ...
        <div class="list-group">
            <a href="{{ url('profile-edit') }}" class="list-group-item list-group-item-action d-flex justify-content-between"><div>Edit Profile</div><i class="icon-users"></i></a>
